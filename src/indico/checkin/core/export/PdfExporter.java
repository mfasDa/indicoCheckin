...
public class PdfExporter {
	 ...
	 public void exportPdf(){
		 try {
		      ...
		      PdfWriter.getInstance(document, new FileOutputStream( getFullFileName() ));
		      document.open();
	 ...
	 private void CreateDocument(Document document)
		 ...
		 switch(template){
		 case 1:
			 document.addTitle(registrant.getID() + "-" + registrant.getSurname() + "_" + registrant.getFirstName() );
			 Paragraph testParagraph = new Paragraph();
			 testParagraph.add(registrant.getFirstName() + " " + registrant.getSurname()  );
